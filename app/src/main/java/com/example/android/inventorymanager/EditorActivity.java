...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                if (mProductNameEditText.getText().toString().trim().isEmpty()) {
                    mProductNameEditText.setError("Missing product name");
                }
                if (mProductPriceEditText.getText().toString().trim().isEmpty()) {
                    mProductPriceEditText.setError("Missing product price");
                }
                if (mProductQuantityEditText.getText().toString().trim().isEmpty()) {
                    mProductQuantityEditText.setError("Missing product quantity");
                }
                if (mSupplierNameEditText.getText().toString().trim().isEmpty()) {
                    mSupplierNameEditText.setError("Missing supplier's name");
                }
                if (mSupplierPhoneNumberEditText.getText().toString().trim().isEmpty()) {
                    mSupplierPhoneNumberEditText.setError("Missing supplier's phone number");
                }
                if (mSupplierEmailAddressEditText.getText().toString().trim().isEmpty()) {
                    mSupplierEmailAddressEditText.setError("Missing supplier's email address");
                }
                if (fileUri == null) {
    ...
    private void showOrderConfirmationDialog() {
        ...
        builder.setNegativeButton(R.string.email, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                String bodyMessage = "You are requested to send more " +
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            Log.v("EditorActivity", mProductQuantityEditText.getText().toString());
